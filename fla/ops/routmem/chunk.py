...
def chunk_routmem_fwd_k_kernel_inter(
    q,
    k,
    h,
    g,
...
@triton.jit(do_not_specialize=['T'])
def chunk_routmem_fwd_k_kernel_intra(
    v,
    g,
    o,
    A,
...
@triton.jit(do_not_specialize=['T'])
def chunk_routmem_bwd_k_kernel_dA(
    v,
    g,
    do,
    dA,
...
@triton.jit(do_not_specialize=['T'])
def chunk_routmem_bwd_k_kernel_dqkvg(
    q,
    k,
    v,
    h,
...
@triton.jit(do_not_specialize=['T'])
def chunk_routmem_bwd_k_kernel_intra_dvg(
    v,
    g,
    o,
    A,
...
def chunk_routmem_fwd_k(
    ...
    chunk_routmem_fwd_k_kernel_inter[grid](
        q,
        k,
        h,
        g,
    ...
    chunk_routmem_fwd_k_kernel_intra[grid](
        v,
        g,
        o,
        A,
...
def chunk_routmem_bwd_k(
    ...
    chunk_routmem_bwd_k_kernel_dA[grid](
        v,
        g,
        do,
        dA,
    ...
    grid = (NK, NT, B * HQ)
    chunk_routmem_bwd_k_kernel_dqkvg[grid](
        q,
        k,
        v,
        h,
    ...
    def grid(meta): return (triton.cdiv(V, meta['BV']), NT * NC, B * HQ)
    chunk_routmem_bwd_k_kernel_intra_dvg[grid](
        v,
        g,
        o,
        A,
...
def chunk_routmem_fwd(
    ...
    Ak, hk, hkt, ok = chunk_routmem_fwd_k(
        q=q,
        k=k,
        v=s,
        g=g,
    ...
    qv = p.to(q.dtype)
    Av, hv, hvt, ov = chunk_routmem_fwd_v(
        q=qv,
        k=s,
        v=v,
        g=g,
...
def chunk_routmem_bwd(
    ...
    qv = p.to(q.dtype)
    dqv, dsv, dv, dg, dhv0 = chunk_routmem_bwd_v(
        q=qv,
        k=s,
        v=v,
        g=g,
    ...
    dq, dk, dsk, dg, dhk0 = chunk_routmem_bwd_k(
        q=q,
        k=k,
        v=s,
        g=g,
...
class ChunkRoutMemFunction(torch.autograd.Function):
    ...
    def forward(
        ...
        Ak, hk, hkt, ok, p, Av, hv, hvt, ov = chunk_routmem_fwd(
            q=q,
            k=k,
            v=v,
            s=s,
    ...
    def backward(ctx, dov, dhkt=None, dhvt=None):
        ...
        dq, dk, dv, ds, dg, dhk0, dhv0 = chunk_routmem_bwd(
            q=q,
            k=k,
            v=v,
            s=s,
...
def chunk_routmem(
    ...
    if initial_state is not None:
        hk0, hv0 = initial_state
    o, *final_state = ChunkRoutMemFunction.apply(
        q,
        k,
        v,
        s,
